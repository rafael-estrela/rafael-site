                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-2"><?=FORGOT_PASSWORD_TITLE?></h1>
                                    <p class="mb-4"><?=FORGOT_PASSWORD_MESSAGE?></p>
                                </div>
                                ...
                                <?php } ?>
                                <form class="user" method="post" action="<?=BASE_ADMIN_URL?>action/forgotPassword/">
                                    ...
                                    <input type="submit" class="btn btn-primary btn-user btn-block" value="<?=FORGOT_PASSWORD_BUTTON?>">
                                </form>
                                <hr>
                                <div class="text-center">
